...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for Heardle.fun music guessing game and iOS app.",
};
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Heardle.fun does not collect or store any personal information
                that can be tied to individual users. We only collect anonymous
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li>
                  Contact us with any privacy concerns at privacy@heardle.fun
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700">Email: privacy@heardle.fun</p>
            </section>
          </div>
